...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto" href=""> <strong> <u>
                  <?php echo  $row['Username']; ?>
                </u></strong>
            </a></li>
          <li><a class="nav-link scrollto" href="login.php"><span class="fas fa-sign-out-alt">Logout</span></a></li>
        </ul>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1"
          ...
          <div class="d-flex justify-content-center justify-content-lg-start">
            ...
            <a href="https://youtu.be/mQ93IcGCag4" class="glightbox btn-watch-video"><i
        ...
        <div class="row content">
          <div class="col-lg-6">
            ...
            <ul>
              ...
              <li><i class="ri-check-double-line"></i> See their complain Report and check if the work is done! or not.
              </li>
  ...
  <footer id="footer">
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Double Trio</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        Designed by <strong><span>Double Trio</span></strong>
      </div>
    </div>
  </footer><!-- End Footer -->
